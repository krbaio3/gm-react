...
import { clienteAPI } from './client.service';
// require('./client.scss');
...
export class ClientComponent extends React.Component < {}, State > {
  constructor(props) {
    super(props);
    this.state = { 
      cliente: null, 
  ...
  // public componentWillMount(document) {
  //   ClienteAPI.getClient(document).then((response) => {
  //     this.setState({ cliente: ClienteAPI.getClient() });
  //   });
  // }
              ...
              <form>
                ...
                <div className="col-xs-4 col-lg-6 mb-2">
                  <div className="input-group">
                    ...
                    <span className="input-group-btn">
                      <button className="btn btn-info" type="button" onClick={this.searchDocument(document)}>
                        <i className="fa fa-search" aria-hidden="true" />
                      </button>
                    </span>
                  </div>
...
// export const ClientComponent = ({ cliente }: {cliente : ClienteEntity}) => {
//   return (
//     <div>
//       <br />
//       <form>
